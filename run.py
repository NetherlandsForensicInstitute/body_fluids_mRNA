...
if __name__ == '__main__':
    ...
    save_path = 'scratch/only_vag_menstr'
    nfold_analysis(nfolds=nfolds, tc=target_classes_str, savepath=save_path)
    makeplots(nfolds=nfolds, tc=target_classes_str, path=save_path+'/picklesaves',
              savepath=save_path)
