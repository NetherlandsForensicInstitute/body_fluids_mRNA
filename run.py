...
def perform_analysis():
    ...
    model.fit_classifier(X_augmented, change_labels(y_nhot_augmented))
...
def perform_analysis_splitting_data(nfolds):
    ...
    for n in range(nfolds):
        ...
        model.fit_classifier(X_train_augmented, change_labels(y_train_nhot_augmented))
...
if __name__ == '__main__':
    ...
    N_SAMPLES_PER_COMBINATION_TEST = 3
    ...
    X_mixtures, y_nhot_mixtures, test_map, inv_test_map = \
        read_mixture_data('Datasets/Dataset_mixtures_rv.xlsx', n_celltypes, label_encoder)
